...
const BuyEquipment = () => {
   ...
   return (
      <div className='justify-center flex m-10'>
               ...
               equipment.map((equip) => <div key={equip.equipment_id} className="card card-side bg-[#ffffff] shadow-md">
                  ...
                  <div className="card-body">
                     ...
                     <div className="card-actions justify-end">
                        <button className="btn btn-soft btn-primary " onClick={() => addToCart(equip)}>
                           Add to cart
                        </button>
                     </div>
                  </div>
         ...
         <button
            className="fixed bottom-18 right-20 bg-blue-600 text-white p-4 rounded-full shadow-lg flex items-center gap-2"
